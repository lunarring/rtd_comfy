...
class EmbeddingsMixer:
    ...
    def blend_multi_embeds(self, list_embeds, weights):
        ...
        Args:
            ...
            weights (list): A list of weights for the blending. Each weight corresponds to a set of embeddings in `list_embeds`.
    ...
    def blend_stored_embeddings(self, idx_embeds, weights_embeds):
        """
...
#%%
    ...
    p_emb, neg_p_emb, pool_p_emb, neg_pool_p_emb = em.blend_stored_embeddings(idx_embeds, weights_embeds)
